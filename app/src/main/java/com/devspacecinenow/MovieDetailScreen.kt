...
private fun MovieDetailPreview() {
    CineNowTheme {
        val movie = MovieDto(
            id = 9,
            title = "Title",
            overview = "Long overview movieLong overview movieLong overview movieLong overview movieLong overview movieLong overview movieLong overview movieLong overview movieLong overview movieLong overview movie",
            postPath = "jsadhiuhsad"
